.PHONY: target_directories remove_target_link
.SUFFIXES: .c .o .h .mk
#################################################################################
...
$(TARGET_DIR):
	@ln -s $(addprefix $(ROOT_DIR)/, $@) $@
	@echo "Link $(TARGET_DIR)created."

compile: remove_target_link
dependencies: remove_target_link
remove_target_link:
	@rm $(TARGET_DIR)
endif
#################################################################################
